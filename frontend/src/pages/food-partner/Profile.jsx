...
export default function Profile() {
  ...
  useEffect(() => {
    axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/food-partner/${id}`, { withCredentials: true })
      .then(response => {
  ...
  const handleDelete = async (videoId) => {
    try {
      await axios.delete(`${import.meta.env.VITE_BACKEND_URL}/api/food/${videoId}`, { withCredentials: true });
  ...
  const handleUpdateProfile = async () => {
    try {
      ...
      const response = await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/food-partner/update`, formData, { withCredentials: true });
